...
function deserialize_service_KitAPI_Model_Entity_Geography_Phone(array $jsonData): service\KitAPI\Model\Entity\Geography\Phone
{
    
$model = new service\KitAPI\Model\Entity\Geography\Phone();
