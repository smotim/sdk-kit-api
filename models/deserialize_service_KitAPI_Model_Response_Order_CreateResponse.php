...
function deserialize_service_KitAPI_Model_Response_Order_CreateResponse(array $jsonData): service\KitAPI\Model\Response\Order\CreateResponse
{
    
$model = new service\KitAPI\Model\Response\Order\CreateResponse();
