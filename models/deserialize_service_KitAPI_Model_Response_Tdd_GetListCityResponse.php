...
function deserialize_service_KitAPI_Model_Response_Tdd_GetListCityResponse(array $jsonData): service\KitAPI\Model\Response\Tdd\GetListCityResponse
{
    
$model = new service\KitAPI\Model\Response\Tdd\GetListCityResponse();
if (isset($jsonData)) {
    $model->cities = [];
