...
namespace service\KitAPI\Component\Serializer\Parser;
...
use service\KitAPI\Component\Serializer\Annotation\Accessor;
use service\KitAPI\Component\Serializer\Annotation\AccessorOrder;
use service\KitAPI\Component\Serializer\Annotation\Exclude;
use service\KitAPI\Component\Serializer\Annotation\ExclusionPolicy;
use service\KitAPI\Component\Serializer\Annotation\Groups;
use service\KitAPI\Component\Serializer\Annotation\PostDeserialize;
use service\KitAPI\Component\Serializer\Annotation\SerializedName;
use service\KitAPI\Component\Serializer\Annotation\Since;
use service\KitAPI\Component\Serializer\Annotation\Type;
use service\KitAPI\Component\Serializer\Annotation\Until;
use service\KitAPI\Component\Serializer\Annotation\VirtualProperty;
        ...
        foreach ($annotations as $annotation) {
            switch (true) {
                ...
                default:
                    if (
                        0 === strncmp(
                            'service\KitAPI\Component\Serializer\Annotation\\',
                            get_class($annotation),
                            mb_strlen('service\KitAPI\Component\Serializer\Annotation\\')
                        )
                    ) {
